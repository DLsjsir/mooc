...
<script type="text/javascript">
    function validate() {
        ...
        if (age == "") {
            $("#spanBirth").html(
                "<b style='color:red;font-size:15px;margin-top:auto;'>年龄不能为空！</b>");
        } else {
            $("#spanBirth").html(
                "<div class='glyphicon glyphicon-ok' style='float:left'></div>");
            okAge = true;
        }
        if (okUsername && okPassword && okEmail && okBirth && okAge) {
            $("#form1").submit();
        }
            ...
            <div class="container-fluid full ">
                <form action="regist"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input name="mail" type="text" id="email" placeholder="Email"
                                   class="form-control">
                        </div>
