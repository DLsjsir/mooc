...
<div>
    <div class="container"
        ...
        <p style="font-size: 50px;text-align: center;">Mooc书籍管理</p>
        <div class="container"
            ...
            <table class="table table-striped" width="950">
                <tr>
                    <td class="col-md-2 text-center">书籍ID</td>
                    <td class="col-md-2 text-center">书籍名</td>
                    <td class="col-md-2 text-center">书籍介绍</td>
                    <td class="col-md-2 text-center">书籍评价</td>
                    <td class="col-md-2 text-center">书籍订阅数</td>
                    <td class="col-md-2 text-center">年龄分级</td>
                    <td class="col-md-2 text-center">操作</td>
                    <td class="col-md-2 text-center">详情</td>
                    <td class="col-md-2 text-center">删除书籍</td>
                </tr>
                <c:if test="${courses.size()==0 }">
                    <tr>
                        <td colspan="5" style="font-size: 35px; text-align: center;">暂无书籍
                        </td>
                    </tr>
                </c:if>
                    ...
                    <tr>
                        ...
                        <td class="col-md-2 text-center ">
                            <a class="btn btn-danger delete"
                               ...
                               href="javascript:removecourse(courseid='${order.id }')">删除书籍</a>
                        </td>
                    </tr>
...
<script type="text/javascript">
    ...
    function prevpage(){
        var page = ${page}-1;
        window.location.href="allBooks?page="+page;
    }
    function nextpage(){
        var maxpage = ${maxpage};
        var page = ${page}+1;
    ...
    function removecourse(courseid){
        var r=confirm("确认要删除书籍："+courseid+"?");
        if (r==true){
